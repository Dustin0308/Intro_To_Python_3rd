...
# The first c occurs at index 4, so that's our start value for the slice. Since we want 6 
# characters, the stop value is at index 4 + 6 or 10. Note that the character at index 10 is not 
